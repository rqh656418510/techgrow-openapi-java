...
@Transactional
@SpringBootTest
public class WechatSubscribeUserServiceTest {
	...
	public void list() {
		...
		R result = subscribeUserService.list(pageDto);
	...
	public void save() {
		String toOpenId = ReadmoreConstatns.WECHAT_TO_OPEN_ID;
		String fromOpenId = ReadmoreConstatns.WECHAT_FROM_OPEN_ID;
		WechatSubscribeUserDto dto = new WechatSubscribeUserDto(fromOpenId, toOpenId);
		subscribeUserService.addUser(dto);
	}
	...
	public void updateStatus() {
		String toOpenId = ReadmoreConstatns.WECHAT_TO_OPEN_ID;
		String fromOpenId = ReadmoreConstatns.WECHAT_FROM_OPEN_ID;
		subscribeUserService.updateStatus(fromOpenId, toOpenId, Status.INVALID);
	}
